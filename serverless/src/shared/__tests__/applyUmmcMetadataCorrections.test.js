...
describe('when applying temporal resolution UMM-C corrections', () => {
  test('should ignore temporal resolution corrections because they are not supported', async () => {
    const mockWithTemporal = {
      ShortName: 'TEMP_TEST',
      TemporalExtents: [
        {
          TemporalResolution: {
    ...
    const result = await applyUmmcMetadataCorrections({
      metadataPayload: mockWithTemporal,
      corrections: [
        {
...
describe('when applying vertical resolution UMM-C corrections', () => {
  test('should ignore vertical resolution corrections because they are not supported', async () => {
    const mockWithVertical = {
      ShortName: 'VERT_TEST',
      SpatialExtent: {
    ...
    const result = await applyUmmcMetadataCorrections({
      metadataPayload: mockWithVertical,
      corrections: [
        {
...
describe('when applying horizontal resolution UMM-C corrections', () => {
  test('should ignore horizontal resolution corrections because they are not supported', async () => {
    const mockWithHorizontal = {
      ShortName: 'HORIZ_TEST',
      SpatialExtent: {
    ...
    const result = await applyUmmcMetadataCorrections({
      metadataPayload: mockWithHorizontal,
      corrections: [
        {
