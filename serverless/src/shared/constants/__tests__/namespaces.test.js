...
describe('namespaces', () => {
  ...
  test('should have the correct number of namespaces', () => {
    expect(Object.keys(namespaces).length).toBe(4)
  })

  test('should have the correct namespaces', () => {
  ...
  test('should have the correct URI for each namespace', () => {
  ...
  test('should have all keys starting with @xmlns:', () => {
    Object.keys(namespaces).forEach((key) => {
      expect(key.startsWith('@xmlns:')).toBe(true)
    })
  })

  test('should have all values ending with # or /', () => {
