...
dockerRun() {
  docker run \
        ...
        --env "CONCEPTS_READ_TIMEOUT_MS=${bamboo_CONCEPTS_READ_TIMEOUT_MS:-25000}" \
        --env "SPARQL_WARM_WINDOW_MS=${bamboo_SPARQL_WARM_WINDOW_MS:-60000}" \
        --env "SPARQL_WARM_MAX_RETRIES=${bamboo_SPARQL_WARM_MAX_RETRIES:-0}" \
        --env "SPARQL_COLD_MAX_RETRIES=${bamboo_SPARQL_COLD_MAX_RETRIES:-1}" \
        --env "SPARQL_REQUEST_TIMEOUT_MS=${bamboo_SPARQL_REQUEST_TIMEOUT_MS:-25000}" \
